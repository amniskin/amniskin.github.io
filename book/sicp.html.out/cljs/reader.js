...
var len__6061__auto___252430 = arguments.length;
var i__6062__auto___252431 = (0);
while(true){
if((i__6062__auto___252431 < len__6061__auto___252430)){
args__6068__auto__.push((arguments[i__6062__auto___252431]));

var G__252432 = (i__6062__auto___252431 + (1));
i__6062__auto___252431 = G__252432;
continue;
} else {
}
break;
...
cljs.reader.reader_error.cljs$lang$applyTo = (function (seq252428){
var G__252429 = cljs.core.first(seq252428);
var seq252428__$1 = cljs.core.next(seq252428);
return cljs.reader.reader_error.cljs$core$IFn$_invoke$arity$variadic(G__252429,seq252428__$1);
});
...
var G__252433 = (function (){
sb.append(ch);

return sb;
})()
;
var G__252434 = cljs.reader.read_char(rdr);
sb = G__252433;
ch = G__252434;
continue;
}
...
var a = (cljs.core.truth_((groups[(3)]))?[(groups[(3)]),(10)]:(cljs.core.truth_((groups[(4)]))?[(groups[(4)]),(16)]:(cljs.core.truth_((groups[(5)]))?[(groups[(5)]),(8)]:(cljs.core.truth_((groups[(6)]))?[(groups[(7)]),(function (){var G__252437 = (groups[(6)]);
var G__252438 = (10);
return parseInt(G__252437,G__252438);
})()]:[null,null]
))));
var n = (a[(0)]);
var radix = (a[(1)]);
...
var G__252439 = cljs.reader.read_char(rdr);
ch = G__252439;
continue;
} else {
return ch;
...
var G__252440 = (((mret === rdr))?a:cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(a,mret));
a = G__252440;
continue;
} else {
cljs.reader.unread(rdr,ch);
...
var G__252441 = (((o === rdr))?a:cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(a,o));
a = G__252441;
continue;
}
}
...
var G__252442 = (function (){
buffer.append(ch);

return buffer;
})()
;
var G__252443 = cljs.reader.read_char(reader);
buffer = G__252442;
ch = G__252443;
continue;
}
...
if(("\\" === ch)){
var G__252444 = (function (){
buffer.append(cljs.reader.escape_char(buffer,reader));

return buffer;
})()
;
var G__252445 = cljs.reader.read_char(reader);
buffer = G__252444;
ch = G__252445;
continue;
} else {
...
var G__252446 = (function (){
buffer.append(ch);

return buffer;
})()
;
var G__252447 = cljs.reader.read_char(reader);
buffer = G__252446;
ch = G__252447;
continue;
...
var G__252452 = (function (){var G__252450 = buffer;
G__252450.append(nch);

return G__252450;
})();
var G__252453 = cljs.reader.read_char(reader);
buffer = G__252452;
ch = G__252453;
continue;
}
...
var G__252454 = (function (){var G__252451 = buffer;
G__252451.append(ch);

return G__252451;
})();
var G__252455 = cljs.reader.read_char(reader);
buffer = G__252454;
ch = G__252455;
continue;
...
var G__252458 = reader;
var G__252459 = eof_is_error;
var G__252460 = sentinel;
var G__252461 = is_recursive;
reader = G__252458;
eof_is_error = G__252459;
sentinel = G__252460;
is_recursive = G__252461;
continue;
} else {
if(cljs.reader.comment_prefix_QMARK_(ch)){
var G__252462 = (cljs.reader.read_comment.cljs$core$IFn$_invoke$arity$2 ? cljs.reader.read_comment.cljs$core$IFn$_invoke$arity$2(reader,ch) : cljs.reader.read_comment.call(null,reader,ch));
var G__252463 = eof_is_error;
var G__252464 = sentinel;
var G__252465 = is_recursive;
reader = G__252462;
eof_is_error = G__252463;
sentinel = G__252464;
is_recursive = G__252465;
continue;
} else {
...
if((res === reader)){
var G__252466 = reader;
var G__252467 = eof_is_error;
var G__252468 = sentinel;
var G__252469 = is_recursive;
reader = G__252466;
eof_is_error = G__252467;
sentinel = G__252468;
is_recursive = G__252469;
continue;
} else {
return res;
}
...
var vec__252474 = cljs.core.re_matches(cljs.reader.timestamp_regex,s);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__252474,(0),null);
var years = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__252474,(1),null);
var months = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__252474,(2),null);
var days = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__252474,(3),null);
var hours = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__252474,(4),null);
var minutes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__252474,(5),null);
var seconds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__252474,(6),null);
var fraction = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__252474,(7),null);
var offset_sign = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__252474,(8),null);
var offset_hours = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__252474,(9),null);
var offset_minutes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__252474,(10),null);
var v = vec__252474;
if(cljs.core.not(v)){
...
return new cljs.core.PersistentVector(null, 8, 5, cljs.core.PersistentVector.EMPTY_NODE, [years__$1,cljs.reader.check((1),months__$1,(12),"timestamp month field must be in range 1..12"),cljs.reader.check((1),days__$1,(function (){var G__252475 = months__$1;
var G__252476 = cljs.reader.leap_year_QMARK_(years__$1);
return (cljs.reader.days_in_month.cljs$core$IFn$_invoke$arity$2 ? cljs.reader.days_in_month.cljs$core$IFn$_invoke$arity$2(G__252475,G__252476) : cljs.reader.days_in_month.call(null,G__252475,G__252476));
...
if(cljs.core.truth_(temp__4423__auto__)){
var vec__252478 = temp__4423__auto__;
var years = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__252478,(0),null);
var months = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__252478,(1),null);
var days = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__252478,(2),null);
var hours = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__252478,(3),null);
var minutes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__252478,(4),null);
var seconds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__252478,(5),null);
var ms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__252478,(6),null);
var offset = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__252478,(7),null);
...
var arr = [];
var seq__252491_252503 = cljs.core.seq(form);
var chunk__252492_252504 = null;
var count__252493_252505 = (0);
var i__252494_252506 = (0);
while(true){
if((i__252494_252506 < count__252493_252505)){
var x_252507 = chunk__252492_252504.cljs$core$IIndexed$_nth$arity$2(null,i__252494_252506);
arr.push(x_252507);

var G__252508 = seq__252491_252503;
var G__252509 = chunk__252492_252504;
var G__252510 = count__252493_252505;
var G__252511 = (i__252494_252506 + (1));
seq__252491_252503 = G__252508;
chunk__252492_252504 = G__252509;
count__252493_252505 = G__252510;
i__252494_252506 = G__252511;
continue;
} else {
var temp__4425__auto___252512 = cljs.core.seq(seq__252491_252503);
if(temp__4425__auto___252512){
var seq__252491_252513__$1 = temp__4425__auto___252512;
if(cljs.core.chunked_seq_QMARK_(seq__252491_252513__$1)){
var c__5806__auto___252514 = cljs.core.chunk_first(seq__252491_252513__$1);
var G__252515 = cljs.core.chunk_rest(seq__252491_252513__$1);
var G__252516 = c__5806__auto___252514;
var G__252517 = cljs.core.count(c__5806__auto___252514);
var G__252518 = (0);
seq__252491_252503 = G__252515;
chunk__252492_252504 = G__252516;
count__252493_252505 = G__252517;
i__252494_252506 = G__252518;
continue;
} else {
var x_252519 = cljs.core.first(seq__252491_252513__$1);
arr.push(x_252519);

var G__252520 = cljs.core.next(seq__252491_252513__$1);
var G__252521 = null;
var G__252522 = (0);
var G__252523 = (0);
seq__252491_252503 = G__252520;
chunk__252492_252504 = G__252521;
count__252493_252505 = G__252522;
i__252494_252506 = G__252523;
continue;
}
} else {
}
...
var obj = {};
var seq__252497_252524 = cljs.core.seq(form);
var chunk__252498_252525 = null;
var count__252499_252526 = (0);
var i__252500_252527 = (0);
while(true){
if((i__252500_252527 < count__252499_252526)){
var vec__252501_252528 = chunk__252498_252525.cljs$core$IIndexed$_nth$arity$2(null,i__252500_252527);
var k_252529 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__252501_252528,(0),null);
var v_252530 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__252501_252528,(1),null);
(obj[cljs.core.name(k_252529)] = v_252530);

var G__252531 = seq__252497_252524;
var G__252532 = chunk__252498_252525;
var G__252533 = count__252499_252526;
var G__252534 = (i__252500_252527 + (1));
seq__252497_252524 = G__252531;
chunk__252498_252525 = G__252532;
count__252499_252526 = G__252533;
i__252500_252527 = G__252534;
continue;
} else {
var temp__4425__auto___252535 = cljs.core.seq(seq__252497_252524);
if(temp__4425__auto___252535){
var seq__252497_252536__$1 = temp__4425__auto___252535;
if(cljs.core.chunked_seq_QMARK_(seq__252497_252536__$1)){
var c__5806__auto___252537 = cljs.core.chunk_first(seq__252497_252536__$1);
var G__252538 = cljs.core.chunk_rest(seq__252497_252536__$1);
var G__252539 = c__5806__auto___252537;
var G__252540 = cljs.core.count(c__5806__auto___252537);
var G__252541 = (0);
seq__252497_252524 = G__252538;
chunk__252498_252525 = G__252539;
count__252499_252526 = G__252540;
i__252500_252527 = G__252541;
continue;
} else {
var vec__252502_252542 = cljs.core.first(seq__252497_252536__$1);
var k_252543 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__252502_252542,(0),null);
var v_252544 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__252502_252542,(1),null);
(obj[cljs.core.name(k_252543)] = v_252544);

var G__252545 = cljs.core.next(seq__252497_252536__$1);
var G__252546 = null;
var G__252547 = (0);
var G__252548 = (0);
seq__252497_252524 = G__252545;
chunk__252498_252525 = G__252546;
count__252499_252526 = G__252547;
i__252500_252527 = G__252548;
continue;
}
} else {
}
...
cljs.reader._STAR_tag_table_STAR_ = (function (){var G__252549 = new cljs.core.PersistentArrayMap(null, 4, ["inst",cljs.reader.read_date,"uuid",cljs.reader.read_uuid,"queue",cljs.reader.read_queue,"js",cljs.reader.read_js], null);
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__252549) : cljs.core.atom.call(null,G__252549));
})();
...
var G__252553 = cljs.reader.read(rdr,true,null,false);
return (pfn.cljs$core$IFn$_invoke$arity$1 ? pfn.cljs$core$IFn$_invoke$arity$1(G__252553) : pfn.call(null,G__252553));
} else {
if(cljs.core.truth_(dfn)){
var G__252554 = tag;
var G__252555 = cljs.reader.read(rdr,true,null,false);
return (dfn.cljs$core$IFn$_invoke$arity$2 ? dfn.cljs$core$IFn$_invoke$arity$2(G__252554,G__252555) : dfn.call(null,G__252554,G__252555));
} else {
