...
var len__6061__auto___6830 = arguments.length;
var i__6062__auto___6831 = (0);
while(true){
if((i__6062__auto___6831 < len__6061__auto___6830)){
args__6068__auto__.push((arguments[i__6062__auto___6831]));

var G__6832 = (i__6062__auto___6831 + (1));
i__6062__auto___6831 = G__6832;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__6828){
var vec__6829 = p__6828;
var opts = cljs.core.nth.call(null,vec__6829,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__6829,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__6829,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__6829,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__6829,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq6826){
var G__6827 = cljs.core.first.call(null,seq6826);
var seq6826__$1 = cljs.core.next.call(null,seq6826);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__6827,seq6826__$1);
});
