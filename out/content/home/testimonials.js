...
var vec__165626 = tailrecursion.hoplon.parse_args(args__10403__auto__);
var map__165627 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__165626,(0),null);
var map__165627__$1 = ((cljs.core.seq_QMARK_(map__165627))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__165627):map__165627);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__165627__$1,cljs.core.constant$keyword$name);
var place = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__165627__$1,cljs.core.constant$keyword$place);
var date = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__165627__$1,cljs.core.constant$keyword$date);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__165626,(1),null);
var G__165628 = cljs.core.constant$keyword$class;
var G__165629 = "small";
var G__165630 = [cljs.core.str("- "),cljs.core.str(name),cljs.core.str(", "),cljs.core.str(place),cljs.core.str(" "),cljs.core.str(date)].join('');
return (tailrecursion.hoplon.p.cljs$core$IFn$_invoke$arity$3 ? tailrecursion.hoplon.p.cljs$core$IFn$_invoke$arity$3(G__165628,G__165629,G__165630) : tailrecursion.hoplon.p.call(null,G__165628,G__165629,G__165630));
};
var content$home$testimonials$from = function (var_args){
var args__10403__auto__ = null;
if (arguments.length > 0) {
var G__165631__i = 0, G__165631__a = new Array(arguments.length -  0);
while (G__165631__i < G__165631__a.length) {G__165631__a[G__165631__i] = arguments[G__165631__i + 0]; ++G__165631__i;}
  args__10403__auto__ = new cljs.core.IndexedSeq(G__165631__a,0);
} 
...
content$home$testimonials$from.cljs$lang$applyTo = (function (arglist__165632){
var args__10403__auto__ = cljs.core.seq(arglist__165632);
...
var vec__165635 = tailrecursion.hoplon.parse_args(args__10403__auto__);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__165635,(0),null);
var kids = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__165635,(1),null);
var G__165636 = kids;
return (tailrecursion.hoplon.h3.cljs$core$IFn$_invoke$arity$1 ? tailrecursion.hoplon.h3.cljs$core$IFn$_invoke$arity$1(G__165636) : tailrecursion.hoplon.h3.call(null,G__165636));
};
var content$home$testimonials$heading = function (var_args){
var args__10403__auto__ = null;
if (arguments.length > 0) {
var G__165637__i = 0, G__165637__a = new Array(arguments.length -  0);
while (G__165637__i < G__165637__a.length) {G__165637__a[G__165637__i] = arguments[G__165637__i + 0]; ++G__165637__i;}
  args__10403__auto__ = new cljs.core.IndexedSeq(G__165637__a,0);
} 
...
content$home$testimonials$heading.cljs$lang$applyTo = (function (arglist__165638){
var args__10403__auto__ = cljs.core.seq(arglist__165638);
...
var vec__165641 = tailrecursion.hoplon.parse_args(args__10403__auto__);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__165641,(0),null);
var kids = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__165641,(1),null);
var G__165642 = kids;
return (tailrecursion.hoplon.p.cljs$core$IFn$_invoke$arity$1 ? tailrecursion.hoplon.p.cljs$core$IFn$_invoke$arity$1(G__165642) : tailrecursion.hoplon.p.call(null,G__165642));
};
var content$home$testimonials$review = function (var_args){
var args__10403__auto__ = null;
if (arguments.length > 0) {
var G__165643__i = 0, G__165643__a = new Array(arguments.length -  0);
while (G__165643__i < G__165643__a.length) {G__165643__a[G__165643__i] = arguments[G__165643__i + 0]; ++G__165643__i;}
  args__10403__auto__ = new cljs.core.IndexedSeq(G__165643__a,0);
} 
...
content$home$testimonials$review.cljs$lang$applyTo = (function (arglist__165644){
var args__10403__auto__ = cljs.core.seq(arglist__165644);
...
var vec__165649 = tailrecursion.hoplon.parse_args(args__10403__auto__);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__165649,(0),null);
var kids = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__165649,(1),null);
return ui.style.container.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([(function (){var G__165650 = cljs.core.constant$keyword$style;
var G__165651 = "text-align: center;";
var G__165652 = "What my clients think of me.";
return (tailrecursion.hoplon.h1.cljs$core$IFn$_invoke$arity$3 ? tailrecursion.hoplon.h1.cljs$core$IFn$_invoke$arity$3(G__165650,G__165651,G__165652) : tailrecursion.hoplon.h1.call(null,G__165650,G__165651,G__165652));
...
var args__10403__auto__ = null;
if (arguments.length > 0) {
var G__165653__i = 0, G__165653__a = new Array(arguments.length -  0);
while (G__165653__i < G__165653__a.length) {G__165653__a[G__165653__i] = arguments[G__165653__i + 0]; ++G__165653__i;}
  args__10403__auto__ = new cljs.core.IndexedSeq(G__165653__a,0);
} 
...
content$home$testimonials$content.cljs$lang$applyTo = (function (arglist__165654){
var args__10403__auto__ = cljs.core.seq(arglist__165654);
