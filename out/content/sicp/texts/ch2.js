...
var vec__128998 = tailrecursion.hoplon.parse_args(args__10403__auto__);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__128998,(0),null);
var kids = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__128998,(1),null);
return content.sicp.book_data.chapter.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$title,"Building Abstractions with Data"], null),(function (){var _STAR_references_STAR_128999 = tailrecursion.hoplon.markdown._STAR_references_STAR_;
var _STAR_abbreviations_STAR_129000 = tailrecursion.hoplon.markdown._STAR_abbreviations_STAR_;
...
try{var _STAR_references_STAR_129001 = tailrecursion.hoplon.markdown._STAR_references_STAR_;
var _STAR_abbreviations_STAR_129002 = tailrecursion.hoplon.markdown._STAR_abbreviations_STAR_;
...
try{return new cljs.core.PersistentVector(null, 14, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__129003 = cljs.core.PersistentArrayMap.EMPTY;
var G__129004 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__129005 = cljs.core.PersistentArrayMap.EMPTY;
var G__129006 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, ["We now come to the decisive step of mathematical abstraction: we forget about what the symbols stand for. ",(function (){var G__129007 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$type,cljs.core.constant$keyword$ellipsis], null);
var G__129008 = cljs.core.PersistentVector.EMPTY;
return (tailrecursion.hoplon.markdown.simple_node.cljs$core$IFn$_invoke$arity$2 ? tailrecursion.hoplon.markdown.simple_node.cljs$core$IFn$_invoke$arity$2(G__129007,G__129008) : tailrecursion.hoplon.markdown.simple_node.call(null,G__129007,G__129008));
...
return (tailrecursion.hoplon.markdown.para_node.cljs$core$IFn$_invoke$arity$2 ? tailrecursion.hoplon.markdown.para_node.cljs$core$IFn$_invoke$arity$2(G__129005,G__129006) : tailrecursion.hoplon.markdown.para_node.call(null,G__129005,G__129006));
})(),(function (){var G__129009 = cljs.core.PersistentArrayMap.EMPTY;
var G__129010 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Hermann Weyl, ",tailrecursion.hoplon.markdown.strong_emph_super_node.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$chars,"*",cljs.core.constant$keyword$closed,true,cljs.core.constant$keyword$strong,false], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["The Mathematical Way of Thinking"], null)], 0))], null);
...
var G__129018 = new cljs.core.PersistentVector(null, 11, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Consider the task of designing a system to perform arithmetic with rational numbers. We could imagine an operation ",(function (){var G__129019 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$text,"add-rat"], null);
var G__129020 = cljs.core.PersistentVector.EMPTY;
return (tailrecursion.hoplon.markdown.code_node.cljs$core$IFn$_invoke$arity$2 ? tailrecursion.hoplon.markdown.code_node.cljs$core$IFn$_invoke$arity$2(G__129019,G__129020) : tailrecursion.hoplon.markdown.code_node.call(null,G__129019,G__129020));
})()," that takes two rational numbers and produces their sum. In terms of simple data, a rational number can be thought of as two integers: a numerator and a denominator. Thus, we could design a program in which each rational number would be represented by two integers (a numerator and a denominator) and where add-rat would be implemented by two procedures (one producing the numerator of the sum and one producing the denominator). But this would be awkward, because we would then need to explicitly keep track of which numerators corresponded to which denominators. In a system intended to perform many operations on many rational numbers, such bookkeeping details would clutter the programs substantially, to say nothing of what they would do to our minds. It would be much better if we could ",(function (){var G__129021 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$type,cljs.core.constant$keyword$double], null);
var G__129022 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["glue together"], null);
return (tailrecursion.hoplon.markdown.quoted_node.cljs$core$IFn$_invoke$arity$2 ? tailrecursion.hoplon.markdown.quoted_node.cljs$core$IFn$_invoke$arity$2(G__129021,G__129022) : tailrecursion.hoplon.markdown.quoted_node.call(null,G__129021,G__129022));
})()," a numerator and denominator to form a pair ",(function (){var G__129023 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$type,cljs.core.constant$keyword$endash], null);
var G__129024 = cljs.core.PersistentVector.EMPTY;
return (tailrecursion.hoplon.markdown.simple_node.cljs$core$IFn$_invoke$arity$2 ? tailrecursion.hoplon.markdown.simple_node.cljs$core$IFn$_invoke$arity$2(G__129023,G__129024) : tailrecursion.hoplon.markdown.simple_node.call(null,G__129023,G__129024));
})()," a ",tailrecursion.hoplon.markdown.strong_emph_super_node.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$chars,"*",cljs.core.constant$keyword$closed,true,cljs.core.constant$keyword$strong,false], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["compound data object"], null)], 0))," ",(function (){var G__129025 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$type,cljs.core.constant$keyword$endash], null);
var G__129026 = cljs.core.PersistentVector.EMPTY;
return (tailrecursion.hoplon.markdown.simple_node.cljs$core$IFn$_invoke$arity$2 ? tailrecursion.hoplon.markdown.simple_node.cljs$core$IFn$_invoke$arity$2(G__129025,G__129026) : tailrecursion.hoplon.markdown.simple_node.call(null,G__129025,G__129026));
...
return (tailrecursion.hoplon.markdown.para_node.cljs$core$IFn$_invoke$arity$2 ? tailrecursion.hoplon.markdown.para_node.cljs$core$IFn$_invoke$arity$2(G__129029,G__129030) : tailrecursion.hoplon.markdown.para_node.call(null,G__129029,G__129030));
})(),(function (){var G__129033 = (function (){var G__129034 = new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$class,"highlight",cljs.core.constant$keyword$style,"background: #f8f8f8"], null);
var G__129035 = (function (){var G__129036 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$style,"line-height: 125%"], null);
var G__129037 = "(";
var G__129038 = (function (){var G__129061 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$style,"color: #008000; font-weight: bold"], null);
var G__129062 = "defn ";
return (tailrecursion.hoplon.span.cljs$core$IFn$_invoke$arity$2 ? tailrecursion.hoplon.span.cljs$core$IFn$_invoke$arity$2(G__129061,G__129062) : tailrecursion.hoplon.span.call(null,G__129061,G__129062));
})();
var G__129039 = (function (){var G__129063 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$style,"color: #19177C"], null);
var G__129064 = "linear-combination";
return (tailrecursion.hoplon.span.cljs$core$IFn$_invoke$arity$2 ? tailrecursion.hoplon.span.cljs$core$IFn$_invoke$arity$2(G__129063,G__129064) : tailrecursion.hoplon.span.call(null,G__129063,G__129064));
})();
var G__129040 = " [";
var G__129041 = (function (){var G__129065 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$style,"color: #19177C"], null);
var G__129066 = "a";
...
var G__129048 = "]\n  (";
var G__129049 = (function (){var G__129073 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$style,"color: #008000"], null);
var G__129074 = "+ ";
...
var G__129050 = "(";
var G__129051 = (function (){var G__129075 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$style,"color: #008000"], null);
var G__129076 = "* ";
...
var G__129052 = (function (){var G__129077 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$style,"color: #19177C"], null);
var G__129078 = "a";
...
var G__129053 = " ";
var G__129054 = (function (){var G__129079 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$style,"color: #19177C"], null);
var G__129080 = "x";
...
var G__129055 = ") (";
var G__129056 = (function (){var G__129081 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$style,"color: #008000"], null);
var G__129082 = "* ";
...
var G__129057 = (function (){var G__129083 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$style,"color: #19177C"], null);
var G__129084 = "b";
...
var G__129058 = " ";
var G__129059 = (function (){var G__129085 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$style,"color: #19177C"], null);
var G__129086 = "y";
...
var G__129060 = ")))\n";
return (tailrecursion.hoplon.pre.cljs$core$IFn$_invoke$arity$25 ? tailrecursion.hoplon.pre.cljs$core$IFn$_invoke$arity$25(G__129036,G__129037,G__129038,G__129039,G__129040,G__129041,G__129042,G__129043,G__129044,G__129045,G__129046,G__129047,G__129048,G__129049,G__129050,G__129051,G__129052,G__129053,G__129054,G__129055,G__129056,G__129057,G__129058,G__129059,G__129060) : tailrecursion.hoplon.pre.call(null,G__129036,G__129037,G__129038,G__129039,G__129040,G__129041,G__129042,G__129043,G__129044,G__129045,G__129046,G__129047,G__129048,G__129049,G__129050,G__129051,G__129052,G__129053,G__129054,G__129055,G__129056,G__129057,G__129058,G__129059,G__129060));
})();
return (tailrecursion.hoplon.div.cljs$core$IFn$_invoke$arity$2 ? tailrecursion.hoplon.div.cljs$core$IFn$_invoke$arity$2(G__129034,G__129035) : tailrecursion.hoplon.div.call(null,G__129034,G__129035));
})();
return (tailrecursion.hoplon.div.cljs$core$IFn$_invoke$arity$1 ? tailrecursion.hoplon.div.cljs$core$IFn$_invoke$arity$1(G__129033) : tailrecursion.hoplon.div.call(null,G__129033));
})(),(function (){var G__129087 = cljs.core.PersistentArrayMap.EMPTY;
var G__129088 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["But suppose we are not concerned only with numbers. Suppose we would like to express, in procedural terms, the idea that one can form linear combinations whenever addition and multiplication are defined ",(function (){var G__129089 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$type,cljs.core.constant$keyword$endash], null);
var G__129090 = cljs.core.PersistentVector.EMPTY;
return (tailrecursion.hoplon.markdown.simple_node.cljs$core$IFn$_invoke$arity$2 ? tailrecursion.hoplon.markdown.simple_node.cljs$core$IFn$_invoke$arity$2(G__129089,G__129090) : tailrecursion.hoplon.markdown.simple_node.call(null,G__129089,G__129090));
})()," for rational numbers, complex numbers, polynomials, or whatever. We could express this as a procedure of the form"], null);
return (tailrecursion.hoplon.markdown.para_node.cljs$core$IFn$_invoke$arity$2 ? tailrecursion.hoplon.markdown.para_node.cljs$core$IFn$_invoke$arity$2(G__129087,G__129088) : tailrecursion.hoplon.markdown.para_node.call(null,G__129087,G__129088));
})(),(function (){var G__129091 = (function (){var G__129092 = new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$class,"highlight",cljs.core.constant$keyword$style,"background: #f8f8f8"], null);
var G__129093 = (function (){var G__129094 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$style,"line-height: 125%"], null);
var G__129095 = "(";
var G__129096 = (function (){var G__129121 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$style,"color: #008000; font-weight: bold"], null);
var G__129122 = "defn ";
...
var G__129097 = (function (){var G__129123 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$style,"color: #19177C"], null);
var G__129124 = "linear-combination";
...
var G__129098 = " [";
var G__129099 = (function (){var G__129125 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$style,"color: #19177C"], null);
var G__129126 = "a";
...
var G__129106 = "]\n  (";
var G__129107 = (function (){var G__129133 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$style,"color: #0000FF"], null);
var G__129134 = "add";
...
var G__129108 = " (";
var G__129109 = (function (){var G__129135 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$style,"color: #0000FF"], null);
var G__129136 = "mul";
...
var G__129110 = " ";
var G__129111 = (function (){var G__129137 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$style,"color: #19177C"], null);
var G__129138 = "a";
...
var G__129112 = " ";
var G__129113 = (function (){var G__129139 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$style,"color: #19177C"], null);
var G__129140 = "x";
...
var G__129114 = ") (";
var G__129115 = (function (){var G__129141 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$style,"color: #0000FF"], null);
var G__129142 = "mul";
...
var G__129118 = " ";
var G__129119 = (function (){var G__129145 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$style,"color: #19177C"], null);
var G__129146 = "y";
...
var G__129120 = ")))\n";
return (tailrecursion.hoplon.pre.cljs$core$IFn$_invoke$arity$27 ? tailrecursion.hoplon.pre.cljs$core$IFn$_invoke$arity$27(G__129094,G__129095,G__129096,G__129097,G__129098,G__129099,G__129100,G__129101,G__129102,G__129103,G__129104,G__129105,G__129106,G__129107,G__129108,G__129109,G__129110,G__129111,G__129112,G__129113,G__129114,G__129115,G__129116,G__129117,G__129118,G__129119,G__129120) : tailrecursion.hoplon.pre.call(null,G__129094,G__129095,G__129096,G__129097,G__129098,G__129099,G__129100,G__129101,G__129102,G__129103,G__129104,G__129105,G__129106,G__129107,G__129108,G__129109,G__129110,G__129111,G__129112,G__129113,G__129114,G__129115,G__129116,G__129117,G__129118,G__129119,G__129120));
})();
return (tailrecursion.hoplon.div.cljs$core$IFn$_invoke$arity$2 ? tailrecursion.hoplon.div.cljs$core$IFn$_invoke$arity$2(G__129092,G__129093) : tailrecursion.hoplon.div.call(null,G__129092,G__129093));
})();
return (tailrecursion.hoplon.div.cljs$core$IFn$_invoke$arity$1 ? tailrecursion.hoplon.div.cljs$core$IFn$_invoke$arity$1(G__129091) : tailrecursion.hoplon.div.call(null,G__129091));
})(),(function (){var G__129147 = cljs.core.PersistentArrayMap.EMPTY;
var G__129148 = cljs.core.PersistentVector.fromArray(["where ",(function (){var G__129149 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$text,"add"], null);
var G__129150 = cljs.core.PersistentVector.EMPTY;
return (tailrecursion.hoplon.markdown.code_node.cljs$core$IFn$_invoke$arity$2 ? tailrecursion.hoplon.markdown.code_node.cljs$core$IFn$_invoke$arity$2(G__129149,G__129150) : tailrecursion.hoplon.markdown.code_node.call(null,G__129149,G__129150));
})()," and ",(function (){var G__129151 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$text,"mul"], null);
var G__129152 = cljs.core.PersistentVector.EMPTY;
return (tailrecursion.hoplon.markdown.code_node.cljs$core$IFn$_invoke$arity$2 ? tailrecursion.hoplon.markdown.code_node.cljs$core$IFn$_invoke$arity$2(G__129151,G__129152) : tailrecursion.hoplon.markdown.code_node.call(null,G__129151,G__129152));
})()," are not the primitive procedures + and * but rather more complex things that will perform the appropriate operations for whatever kinds of data we pass in as the arguments ",(function (){var G__129153 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$text,"a"], null);
...
})(),", ",(function (){var G__129155 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$text,"b"], null);
...
})(),", ",(function (){var G__129157 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$text,"x"], null);
...
})(),", and ",(function (){var G__129159 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$text,"y"], null);
...
})(),". The key point is that the only thing ",(function (){var G__129161 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$text,"linear-combination"], null);
...
})()," should need to know about ",(function (){var G__129163 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$text,"a"], null);
...
})(),", ",(function (){var G__129165 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$text,"b"], null);
...
})(),", ",(function (){var G__129167 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$text,"x"], null);
...
})(),", and ",(function (){var G__129169 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$text,"y"], null);
...
})()," is that the procedures ",(function (){var G__129171 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$text,"add"], null);
...
})()," and ",(function (){var G__129173 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$text,"mul"], null);
...
})()," will perform the appropriate manipulations. From the perspective of the procedure ",(function (){var G__129175 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$text,"linear-combination"], null);
...
})(),", it is irrelevant what ",(function (){var G__129177 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$text,"a"], null);
...
})(),", ",(function (){var G__129179 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$text,"b"], null);
...
})(),", ",(function (){var G__129181 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$text,"x"], null);
...
})(),", and ",(function (){var G__129183 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$text,"y"], null);
...
})()," are and even more irrelevant how they might happen to be represented in terms of more primitive data. This same example shows why it is important that our programming language provide the ability to manipulate compound objects directly: Without this, there is no way for a procedure such as ",(function (){var G__129185 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$text,"linear-combination"], null);
...
})()," to pass its arguments along to ",(function (){var G__129187 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$text,"add"], null);
...
})()," and ",(function (){var G__129189 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$text,"mul"], null);
...
})()," without having to know their detailed structure.",(function (){var G__129191 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$type,cljs.core.constant$keyword$double_DASH_angle], null);
var G__129192 = new cljs.core.PersistentVector(null, 15, 5, cljs.core.PersistentVector.EMPTY_NODE, ["The ability to directly manipulate procedures provides an analogous increase in the expressive power of a programming language. For example, in ",tailrecursion.hoplon.markdown.exp_link_node.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$url,"#!/sicp/ch/1/sect/3/sub/1/",cljs.core.constant$keyword$title,""], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["section 1.3.1"], null)], 0))," we introduced the ",(function (){var G__129193 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$text,"sum"], null);
...
})()," procedure, which takes a procedure ",(function (){var G__129195 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$text,"term"], null);
var G__129196 = cljs.core.PersistentVector.EMPTY;
return (tailrecursion.hoplon.markdown.code_node.cljs$core$IFn$_invoke$arity$2 ? tailrecursion.hoplon.markdown.code_node.cljs$core$IFn$_invoke$arity$2(G__129195,G__129196) : tailrecursion.hoplon.markdown.code_node.call(null,G__129195,G__129196));
})()," as an argument and computes the sum of the values of ",(function (){var G__129197 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$text,"term"], null);
...
})()," over some specified interval. In order to define ",(function (){var G__129199 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$text,"sum"], null);
...
})(),", it is crucial that we be able to speak of a procedure such as term as an entity in its own right, without regard for how term might be expressed with more primitive operations. Indeed, if we did not have the notion of ",(function (){var G__129201 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$type,cljs.core.constant$keyword$double], null);
var G__129202 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["a procedure,"], null);
return (tailrecursion.hoplon.markdown.quoted_node.cljs$core$IFn$_invoke$arity$2 ? tailrecursion.hoplon.markdown.quoted_node.cljs$core$IFn$_invoke$arity$2(G__129201,G__129202) : tailrecursion.hoplon.markdown.quoted_node.call(null,G__129201,G__129202));
})()," it is doubtful that we would ever even think of the possibility of defining an operation such as ",(function (){var G__129203 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$text,"sum"], null);
...
return (tailrecursion.hoplon.markdown.quoted_node.cljs$core$IFn$_invoke$arity$2 ? tailrecursion.hoplon.markdown.quoted_node.cljs$core$IFn$_invoke$arity$2(G__129191,G__129192) : tailrecursion.hoplon.markdown.quoted_node.call(null,G__129191,G__129192));
...
return (tailrecursion.hoplon.markdown.para_node.cljs$core$IFn$_invoke$arity$2 ? tailrecursion.hoplon.markdown.para_node.cljs$core$IFn$_invoke$arity$2(G__129147,G__129148) : tailrecursion.hoplon.markdown.para_node.call(null,G__129147,G__129148));
})(),(function (){var G__129205 = cljs.core.PersistentArrayMap.EMPTY;
var G__129206 = new cljs.core.PersistentVector(null, 15, 5, cljs.core.PersistentVector.EMPTY_NODE, ["We will see that the key to forming compound data is that a programming language should provide some kind of ",(function (){var G__129207 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$type,cljs.core.constant$keyword$double], null);
var G__129208 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["glue"], null);
return (tailrecursion.hoplon.markdown.quoted_node.cljs$core$IFn$_invoke$arity$2 ? tailrecursion.hoplon.markdown.quoted_node.cljs$core$IFn$_invoke$arity$2(G__129207,G__129208) : tailrecursion.hoplon.markdown.quoted_node.call(null,G__129207,G__129208));
})()," so that data objects can be combined to form more complex data objects. There are many possible kinds of glue. Indeed, we will discover how to form compound data using no special ",(function (){var G__129209 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$type,cljs.core.constant$keyword$double], null);
var G__129210 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["data"], null);
return (tailrecursion.hoplon.markdown.quoted_node.cljs$core$IFn$_invoke$arity$2 ? tailrecursion.hoplon.markdown.quoted_node.cljs$core$IFn$_invoke$arity$2(G__129209,G__129210) : tailrecursion.hoplon.markdown.quoted_node.call(null,G__129209,G__129210));
})()," operations at all, only procedures. This will further blur the distinction between ",(function (){var G__129211 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$type,cljs.core.constant$keyword$double], null);
var G__129212 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["procedure"], null);
...
})()," and ",(function (){var G__129213 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$type,cljs.core.constant$keyword$double], null);
...
})()," which was already becoming tenuous toward the end of chapter 1. We will also explore some conventional techniques for representing sequences and trees. One key idea in dealing with compound data is the notion of ",tailrecursion.hoplon.markdown.strong_emph_super_node.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$chars,"*",cljs.core.constant$keyword$closed,true,cljs.core.constant$keyword$strong,false], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["closure"], null)], 0))," ",(function (){var G__129215 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$type,cljs.core.constant$keyword$endash], null);
var G__129216 = cljs.core.PersistentVector.EMPTY;
return (tailrecursion.hoplon.markdown.simple_node.cljs$core$IFn$_invoke$arity$2 ? tailrecursion.hoplon.markdown.simple_node.cljs$core$IFn$_invoke$arity$2(G__129215,G__129216) : tailrecursion.hoplon.markdown.simple_node.call(null,G__129215,G__129216));
...
return (tailrecursion.hoplon.markdown.para_node.cljs$core$IFn$_invoke$arity$2 ? tailrecursion.hoplon.markdown.para_node.cljs$core$IFn$_invoke$arity$2(G__129205,G__129206) : tailrecursion.hoplon.markdown.para_node.call(null,G__129205,G__129206));
})(),(function (){var G__129217 = cljs.core.PersistentArrayMap.EMPTY;
var G__129218 = new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, ["We will then augment the representational power of our language by introducing ",tailrecursion.hoplon.markdown.strong_emph_super_node.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$chars,"*",cljs.core.constant$keyword$closed,true,cljs.core.constant$keyword$strong,false], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["symbolic expressions"], null)], 0))," ",(function (){var G__129219 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$type,cljs.core.constant$keyword$endash], null);
...
}finally {tailrecursion.hoplon.markdown._STAR_abbreviations_STAR_ = _STAR_abbreviations_STAR_129002;

tailrecursion.hoplon.markdown._STAR_references_STAR_ = _STAR_references_STAR_129001;
}}finally {tailrecursion.hoplon.markdown._STAR_abbreviations_STAR_ = _STAR_abbreviations_STAR_129000;

tailrecursion.hoplon.markdown._STAR_references_STAR_ = _STAR_references_STAR_128999;
}})()], 0));
};
var content$sicp$texts$ch2$content = function (var_args){
var args__10403__auto__ = null;
if (arguments.length > 0) {
var G__129223__i = 0, G__129223__a = new Array(arguments.length -  0);
while (G__129223__i < G__129223__a.length) {G__129223__a[G__129223__i] = arguments[G__129223__i + 0]; ++G__129223__i;}
  args__10403__auto__ = new cljs.core.IndexedSeq(G__129223__a,0);
} 
...
content$sicp$texts$ch2$content.cljs$lang$applyTo = (function (arglist__129224){
var args__10403__auto__ = cljs.core.seq(arglist__129224);
