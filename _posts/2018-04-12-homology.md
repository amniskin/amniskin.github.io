...
Like if we take the m&ouml;bius strip and make the following additional association, you get something called the Cross Cap (also not embeddable in 3D space).
...
So we've triangulated some things, defined what simplicies and simplicial complexes are, but we haven't yet found their utility. For that, just stay tuned! In the next episode we'll go over Betti Numbers and how to compute them using these simplicial complexes!
