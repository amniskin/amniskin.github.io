...
var len__6061__auto___7110 = arguments.length;
var i__6062__auto___7111 = (0);
while(true){
if((i__6062__auto___7111 < len__6061__auto___7110)){
args__6068__auto__.push((arguments[i__6062__auto___7111]));

var G__7112 = (i__6062__auto___7111 + (1));
i__6062__auto___7111 = G__7112;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__7108){
var vec__7109 = p__7108;
var opts = cljs.core.nth.call(null,vec__7109,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__7109,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__7109,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__7109,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__7109,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq7106){
var G__7107 = cljs.core.first.call(null,seq7106);
var seq7106__$1 = cljs.core.next.call(null,seq7106);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__7107,seq7106__$1);
});
